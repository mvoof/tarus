...
/// Source of an external type definition
#[derive(Debug, Clone, PartialEq, Eq)]
pub enum BindingSource {
    /// Generated by ts-rs crate (#[derive(TS)])
    TsRs,
    /// Generated by tauri-specta (#[derive(specta::Type)])
    Specta,
    /// Generated by tauri-typegen (tauri.conf.json plugin)
    Typegen,
    /// User-specified custom bindings file
    Custom,
}

/// An external type definition parsed from generated TypeScript files
#[derive(Debug, Clone)]
pub struct ExternalTypeEntry {
    /// Which tool generated this type
    pub source: BindingSource,
    /// TypeScript name of the type
    pub ts_name: String,
    /// Fields (for struct/interface types)
    pub fields: Option<Vec<Parameter>>,
    /// Variants (for enum/union types)
    pub variants: Option<Vec<String>>,
    /// Raw TypeScript type body (for structural comparison)
    pub raw_ts_body: Option<String>,
}
